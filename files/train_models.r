...
train_glmnet <- function(train_features, test_features,not_included_feature_indices=c(1:5), alpha=0.5,nlambda=50, tune_lambda=TRUE,nofReplications=2,nFolds=10,trace=T){
    ...
    glm_features <-as.data.table(glm_features)
