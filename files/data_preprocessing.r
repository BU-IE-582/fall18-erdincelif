...
details_data_preprocessing <- function(odd_details_raw,matches,which_bets=c('1x2'),remove_bookmaker=c('BetfairExchange','PaddyPower'),removeOlderThan=30){
  # data manipulation for historical odd data
  data<-odd_details_raw
