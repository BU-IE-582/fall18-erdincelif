...
## bwin
data_1 =odd_details[bookmaker=='youwin']
# data_x =odd_details[bookmaker=='youwin'& betType=='dc']
...
plot(pca, main = 'Youwin odds - PCA analysis')
...
biplot(pca, main="Youwin - PCA - Biplot")
plot(pca$scores[,1],pca$scores[,2],col=merged_all_1$IsOver+1,pch=".",cex=5, main = "Youwin - PCA Analysis - Over/Under 2.5")
legend(-11, 8, legend=c("UNDER 2.5", "OVER 2.5"),
...
plot(mds.values_m[,1],mds.values_m[,2],xlab='', ylab='',col=1, pch='.',cex=5, main = "Youwin - MDS plot using Manhattan distance")
...
plot(mds.values[,1],mds.values[,2],pch='.',cex=5, main="Youwin - MDS plot using Euclidean distance",xlab='', ylab='',col=1)
