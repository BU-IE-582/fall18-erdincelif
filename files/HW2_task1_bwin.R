...
## bwin
data_1 =odd_details[bookmaker=='bwin']
...
plot(pca, main = 'Bwin odds - PCA analysis')
...
biplot(pca, main="Bwin - PCA - Biplot")
plot(pca$scores[,1],pca$scores[,2],col=merged_all_1$IsOver+1,pch=".",cex=5, main = "Bwin - PCA Analysis - Over/Under 2.5")
...
plot(mds.values_m[,1],mds.values_m[,2],xlab='', ylab='',col=1, pch='.',cex=5, main = "Bwin - MDS plot using Manhattan distance")
...
plot(mds.values[,1],mds.values[,2],pch='.',cex=5, main="Bwin - MDS plot using Euclidean distance",xlab='', ylab='',col=1)
